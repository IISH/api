...
if [ "$dataset" == "" ];
then
    echo "A dataset is needed to harvest." > $LOG
    cat $LOG
    exit 1
fi
...
#-----------------------------------------------------------------------------------------------------------------------
# Enter the bin folder and create a link to the data folder for this dataset.
#-----------------------------------------------------------------------------------------------------------------------
...
then
	...
	echo "Already processing... ${catalog_file}">$LOG
