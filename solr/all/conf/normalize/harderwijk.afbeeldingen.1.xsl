...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="Record">
        ...
        <xsl:variable name="identifier" select="concat('harderwijk:afbeeldingen:1:', Fotonummer)" />
        <xsl:variable name="isShownBy" select="concat('http://www.collectiegelderland.nl/images/harderwk/_300/', Fotonummer, '.jpg')"/>
        <xsl:variable name="isShownAt" select="concat('http://www.collectiegelderland.nl/musea/stadsmuseum-harderwijk/voorwerp-', Fotonummer)"/>
